...
document.getElementById('use-weather').addEventListener('click', function() {
    window.open('https://adamh1223.github.io/weather-buddy/', '_blank');
});
document.getElementById('weather-github').addEventListener('click', function() {
    window.open('https://github.com/adamh1223/weather-buddy', '_blank');
});
